...
it("covers every executable module with at least three failures",()=>{expect(systems).toHaveLength(12);for(const s of systems)expect(plansFor(s).length).toBeGreaterThanOrEqual(3)});
