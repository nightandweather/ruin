...
export const STAR_SYSTEMS: readonly StarSystemCandidate[] = [
  {
    id: "sol", name: "Solar System", distanceLy: 0, spectralType: "G2 V", luminositySolar: 1,
    ageGyr: 4.6, confirmedPlanetCount: 8, activity: "low", materialAccess: 100, orbitalSimplicity: 88,
  ...
  {
    id: "epsilon-eridani", name: "Epsilon Eridani", distanceLy: 10.45, spectralType: "K2 V", luminositySolar: 0.381,
    ageGyr: 0.6, confirmedPlanetCount: 1, activity: "high", materialAccess: 95, orbitalSimplicity: 68,
  ...
  {
    id: "tau-ceti", name: "Tau Ceti", distanceLy: 11.75, spectralType: "G8.5 V", luminositySolar: 0.495,
    ageGyr: 12.12, confirmedPlanetCount: 3, activity: "low", materialAccess: 78, orbitalSimplicity: 82,
  ...
  {
    id: "proxima-centauri", name: "Proxima Centauri", distanceLy: 4.24, spectralType: "M5.5 V", luminositySolar: 0.00151,
    ageGyr: null, confirmedPlanetCount: 2, activity: "high", materialAccess: 48, orbitalSimplicity: 72,
  ...
  {
    id: "trappist-1", name: "TRAPPIST-1", distanceLy: 40.54, spectralType: "M8.0 V", luminositySolar: 0.000553,
    ageGyr: 7.6, confirmedPlanetCount: 7, activity: "moderate", materialAccess: 70, orbitalSimplicity: 54,
...
export function rankStarSystems(weights: SurveyWeights = DEFAULT_SURVEY_WEIGHTS): SurveyResult[] {
  ...
  return STAR_SYSTEMS.map((system) => {
    ...
    const score = (
      proximity * weights.proximity + stability * weights.stability + energy * weights.energy +
      system.materialAccess * weights.materials + system.orbitalSimplicity * weights.orbitalSimplicity
    ) / totalWeight;
    const strengths = [
