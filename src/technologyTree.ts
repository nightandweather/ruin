...
export type TechnologyDomain = "energy" | "industry" | "mobility" | "communications" | "survivability" | "logistics";
...
export const TECHNOLOGY_TREE: readonly TechnologyNode[] = [
  {
    id: "closed-loop-autonomy", name: "Closed-loop autonomy", domain: "industry", evidence: "demonstrated",
    prerequisites: [], module: "SHARED",
  ...
  {
    id: "in-situ-refining", name: "In-situ resource refining", domain: "industry", evidence: "extrapolated",
    prerequisites: ["closed-loop-autonomy"], module: "FOUNDRY",
  ...
  {
    id: "machine-replication", name: "Partial machine replication", domain: "industry", evidence: "extrapolated",
    prerequisites: ["in-situ-refining"], module: "FOUNDRY",
  ...
  {
    id: "rare-material-ledger", name: "Rare-material provenance ledger", domain: "logistics", evidence: "demonstrated",
    prerequisites: ["in-situ-refining"], module: "SHARED",
  ...
  {
    id: "fusion-grid", name: "High-duty fusion grid", domain: "energy", evidence: "extrapolated",
    prerequisites: ["closed-loop-autonomy"], module: "SHARED",
  ...
  {
    id: "beamed-power", name: "Beamed power network", domain: "energy", evidence: "extrapolated",
    prerequisites: ["fusion-grid"], module: "SHARED",
  ...
  {
    id: "stellar-collector-grid", name: "Stellar collector grid", domain: "energy", evidence: "speculative",
    prerequisites: ["machine-replication", "beamed-power", "rare-material-ledger"], module: "HELIOS",
  ...
  {
    id: "delay-tolerant-relays", name: "Delay-tolerant relay mesh", domain: "communications", evidence: "demonstrated",
    prerequisites: ["closed-loop-autonomy"], module: "SHARED",
  ...
  {
    id: "interstellar-beacon", name: "Interstellar navigation beacon", domain: "communications", evidence: "extrapolated",
    prerequisites: ["delay-tolerant-relays", "beamed-power"], module: "GATE",
  ...
  {
    id: "causal-relay", name: "Causality-aware instant relay", domain: "communications", evidence: "speculative",
    prerequisites: ["interstellar-beacon"], module: "GATE",
  ...
  {
    id: "electric-transport", name: "High-efficiency electric transport", domain: "mobility", evidence: "demonstrated",
    prerequisites: ["fusion-grid"], module: "FLEET",
  ...
  {
    id: "inertial-management", name: "Inertial load management", domain: "mobility", evidence: "extrapolated",
    prerequisites: ["electric-transport", "beamed-power"], module: "FLEET",
  ...
  {
    id: "transit-gate", name: "Metric transit gate", domain: "mobility", evidence: "speculative",
    prerequisites: ["interstellar-beacon", "inertial-management", "causal-relay"], module: "GATE",
  ...
  {
    id: "layered-hull", name: "Layered radiation and debris hull", domain: "survivability", evidence: "demonstrated",
    prerequisites: ["rare-material-ledger"], module: "FLEET",
  ...
  {
    id: "adaptive-field", name: "Adaptive protective field", domain: "survivability", evidence: "speculative",
    prerequisites: ["beamed-power", "layered-hull"], module: "FLEET",
  ...
  {
    id: "autonomous-medbay", name: "Autonomous medical bay", domain: "survivability", evidence: "extrapolated",
    prerequisites: ["closed-loop-autonomy", "layered-hull"], module: "FLEET",
  ...
  {
    id: "salvage-tug", name: "Contactless salvage and capture tug", domain: "logistics", evidence: "extrapolated",
    prerequisites: ["electric-transport", "delay-tolerant-relays"], module: "FLEET",
  ...
  {
    id: "guided-capture", name: "Guided orbital capture corridor", domain: "logistics", evidence: "extrapolated",
    prerequisites: ["salvage-tug", "interstellar-beacon"], module: "SHARED",
  ...
  {
    id: "reconfigurable-fabrication", name: "Reconfigurable fabrication cell", domain: "industry", evidence: "extrapolated",
    prerequisites: ["machine-replication", "rare-material-ledger"], module: "FOUNDRY",
...
export function planTechnology(completeIds: readonly string[]): TechnologyPlan {
  ...
  const blocked = pending
    ...
    .map((technology) => ({ technology, missing: technology.prerequisites.filter((id) => !complete.has(id)) }));
