  ...
  return (
    <main>
      <header className="topbar">
        ...
        <div className="module-links"><a className="module-link" href="/foundry.html">FOUNDRY ↗</a><a className="module-link" href="/collector.html">COLLECTOR ↗</a><a className="module-link" href="/datacore.html">DATACORE ↗</a></div>
