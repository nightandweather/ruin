...
export function DatacoreApp() {
  ...
  return <main className="datacore-shell">
    <header className="datacore-topbar"><div className="datacore-brand"><span>D//C</span><div><strong>RUIN // DATACORE</strong><small>ORBITAL VERIFIED COMPUTE</small></div></div><nav><a href="./">HELIOS</a><a href="./foundry.html">FOUNDRY</a><a href="./collector.html">COLLECTOR</a><b>DATACORE</b><a href="./agraria.html">AGRARIA</a></nav><div className="datacore-status"><span>NODE DC-01 · τ{String(snapshot.tick).padStart(5,"0")}</span><b className={snapshot.mode}>{snapshot.mode.replace("-"," ").toUpperCase()}</b></div></header>
